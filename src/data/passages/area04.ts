...
export const area04: ReadingPassage = {
  ...
  questions: [
    {
      question:
        "According to the passage, how do baby turtles find the ocean after hatching?",
      questionZh: "根據文章，小海龜孵化後如何找到海洋？",
      options: [
        {
          text: "They follow their mother to the water",
          textZh: "牠們跟著母親走向海水",
        },
        {
          text: "They are guided by the light of the moon and stars",
          textZh: "牠們依靠月亮和星星的光導航",
        },
        {
          text: "They smell the salt water from the beach",
          textZh: "牠們從沙灘上聞到海水的鹹味",
        },
        {
          text: "They follow the sound of the waves",
          textZh: "牠們跟隨海浪的聲音",
        },
      ],
      correctIndex: 1,
    ...
    {
      question:
        "According to the passage, what must visitors do when they come to watch the turtles?",
      questionZh: "根據文章，遊客前來觀看海龜時必須遵守什麼規定？",
      options: [
        {
          text: "They must arrive before midnight",
          textZh: "他們必須在午夜前抵達",
        },
        {
          text: "They must book a tour in advance",
          textZh: "他們必須事先預約導覽",
        },
        { text: "They must not use flashlights", textZh: "他們不能使用手電筒" },
        {
          text: "They must stay at least ten meters away",
          textZh: "他們必須保持至少十公尺的距離",
        },
      ],
      correctIndex: 2,
      explanation:
