...
export const area01: ReadingPassage = {
  ...
  questions: [
    {
      question:
        "According to the passage, why did Kevin choose the book about the wild horse?",
      questionZh: "根據文章，凱文為什麼選了那本野馬的書？",
      options: [
        {
          text: "His teacher told him to choose it",
          textZh: "他的老師叫他選那本",
        },
        {
          text: "His classmates said it was interesting",
          textZh: "同學說那本書很有趣",
        },
        {
          text: "It was the thinnest book he could find",
          textZh: "那是他能找到的最薄的書",
        },
        {
          text: "He had always loved stories about animals",
          textZh: "他一直都很喜歡動物故事",
        },
      ],
      correctIndex: 2,
    ...
    {
      question:
        "Which of the following BEST describes Kevin at the end of the story?",
      questionZh: "下列何者最能描述故事結尾的凱文？",
      options: [
        {
          text: "A student who only reads short books",
          textZh: "一個只讀薄書的學生",
        },
        {
          text: "Someone who became a regular reader",
          textZh: "一個養成定期閱讀習慣的人",
        },
        {
          text: "A boy who wants to be a librarian",
          textZh: "一個想當圖書館員的男孩",
        },
    ...
    },
    {
      ...
      options: [
        {
          text: "Why short books are more fun than long ones",
          textZh: "為什麼短書比長書更有趣",
        },
        {
          text: "How a school library helped students do better",
          textZh: "學校圖書館如何幫助學生進步",
        },
        {
          text: "How the right book turned a boy into a reader",
          textZh: "一本對的書如何讓一個男孩愛上閱讀",
        },
        {
          text: "Why students should listen to their teachers",
          textZh: "為什麼學生應該聽從老師的建議",
        },
      ],
      correctIndex: 2,
      explanation:
