  ...
  questions: [
    {
      ...
      options: [
        {
          text: "The contest is open to all students in the school",
          textZh: "比賽對全校學生開放",
        },
        {
          text: "Students may bring two dishes if they want",
          textZh: "學生如果想要可以帶兩道料理",
        },
        {
          text: "Dishes should be prepared before the contest day",
          textZh: "料理應在比賽當天前就先做好",
        },
        {
          text: "The contest is judged only on how the dish looks",
          textZh: "比賽只根據料理外觀評分",
        },
      ],
      correctIndex: 2,
    ...
    },
    {
      ...
      options: [
        {
          text: "Email Ms. Chen before May 10",
          textZh: "在 5 月 10 日前寄信給陳老師",
        },
        {
          text: "Go to Room 201 by May 5",
          textZh: "在 5 月 5 日前到 201 室報名",
        },
        {
          text: "Arrive at the cafeteria before 10:00 a.m.",
          textZh: "在上午 10 點前到達學生餐廳",
        },
        {
          text: "Call the school office to register",
          textZh: "打電話給學校辦公室登記",
        },
      ],
      correctIndex: 1,
    ...
    {
      question:
        "What would most likely happen if a student brought two dishes to the contest?",
      questionZh: "如果一個學生帶了兩道料理去比賽，最可能發生什麼事？",
      options: [
        {
          text: "The student would get extra points for creativity",
          textZh: "學生會因創意加分",
        },
        {
          text: "The judges would pick the better dish to score",
          textZh: "評審會挑比較好的那道來評分",
        },
        {
          text: "The student would not follow the contest rules",
          textZh: "學生沒有遵守比賽規則",
        },
        {
          text: "The student would win a bigger prize",
          textZh: "學生會贏得更大的獎品",
        },
      ],
      correctIndex: 2,
