...
export const area06: ReadingPassage = {
  ...
  questions: [
    {
      question:
        "According to the letter, why did Emily feel upset after Lily moved away?",
      questionZh: "根據信件，柔伊搬走後艾蜜莉為何感到難過？",
      options: [
        {
          text: "She had no one to walk to school with",
          textZh: "她沒有人可以一起走路上學",
        },
        {
          text: "She lost her favorite study partner",
          textZh: "她失去了最好的讀書夥伴",
        },
        {
          text: "She did not like Ms. Wang's class",
          textZh: "她不喜歡王老師的課",
        },
        {
          text: "She could not find anyone who liked the same books",
          textZh: "她找不到喜歡相同書籍的人",
        },
      ],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: [
        {
          text: "She writes letters to students in other schools",
          textZh: "她寫信給其他學校的學生",
        },
        {
          text: "She reads long English novels with Ms. Wang",
          textZh: "她和王老師一起讀長篇英文小說",
        },
        {
          text: "She brings an English article and shares what she found interesting",
          textZh: "她帶一篇英文文章並分享有趣的地方",
        },
        {
          text: "She practices speaking English with Amy every day",
          textZh: "她每天和艾咪練習說英文",
        },
      ],
      correctIndex: 2,
    ...
    },
    {
      ...
      options: [
        {
          text: "She is angry that Lily did not write back sooner",
          textZh: "她因柔伊沒早點回信而生氣",
        },
        {
          text: "She is too sad to enjoy anything at school",
          textZh: "她太難過了，無法享受任何學校活動",
        },
        {
          text: "She is someone who tries to find positive things even when times are hard",
          textZh: "她是個即使在困難時期也努力找到正面事物的人",
        },
        {
          text: "She wishes she could move to a new school like Lily",
          textZh: "她希望自己也能像柔伊一樣轉到新學校",
        },
      ],
      correctIndex: 2,
      explanation:
