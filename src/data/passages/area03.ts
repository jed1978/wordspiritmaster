...
export const area03: ReadingPassage = {
  ...
  questions: [
    {
      question:
        "According to the passage, what did Jason's coach tell him before the race?",
      questionZh: "根據文章，教練在比賽前告訴傑森什麼？",
      options: [
        {
          text: "Try to finish the race as fast as possible",
          textZh: "盡可能跑得越快越好",
        },
        {
          text: "Don't worry about runners from other schools",
          textZh: "不用擔心其他學校的選手",
        },
        {
          text: "Save energy and don't run too fast at the start",
          textZh: "保留體力，起跑時不要太快",
        },
        {
          text: "Warm up for at least one hour before the race",
          textZh: "比賽前至少熱身一小時",
        },
      ],
      correctIndex: 2,
    ...
    },
    {
      ...
      options: [
        {
          text: "He fell down during the race and lost time",
          textZh: "他比賽中跌倒損失了時間",
        },
        {
          text: "The other runner had trained much longer than him",
          textZh: "另一個選手訓練時間比他長很多",
        },
        {
          text: "He did not practice enough before the contest",
          textZh: "他賽前練習不夠充分",
        },
        {
          text: "He ran too fast early on and ran out of energy",
          textZh: "他一開始跑太快，體力提前耗盡",
        },
      ],
      correctIndex: 3,
      explanation:
    ...
    },
    {
      ...
      options: [
        {
          text: "He never listens to anyone's advice",
          textZh: "他從不聽任何人的建議",
        },
        {
          text: "He decided to give up running after losing",
          textZh: "他輸了之後決定放棄跑步",
        },
        {
          text: "He learned from the experience and wanted to improve",
          textZh: "他從這次經驗中學到教訓並想要改進",
        },
        {
          text: "He thought the race result was unfair",
          textZh: "他認為比賽結果不公平",
        },
      ],
      correctIndex: 2,
